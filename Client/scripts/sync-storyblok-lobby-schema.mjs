...
const componentDefinitions = [
  ...
  },
  {
    ...
    schema: {
      ...
      player_in_game_label: field("Player In Game Label", 28),
      change_color_label: field("Change Color Label", 29),
      leave_room_label: field("Leave Room Label", 30),
      remove_player_template: field("Remove Player Template", 31),
      preview_label: field("Preview Label", 32),
      experience_label: field("Experience Label", 33),
      selected_by_template: field("Selected By Template", 34),
      about_experience_label: field("About Experience Label", 35),
      payment_pending_title: field("Payment Pending Title", 36),
      payment_pending_description: field("Payment Pending Description", 37),
      unlocking_template: field("Unlocking Template", 38),
      unlock_button_label: field("Unlock Button Label", 39),
      mode_note: field("Mode Note", 40),
      waiting_for_next_game_note: field("Waiting For Next Game Note", 41),
      host_start_preview_label: field("Host Start Preview Label", 42),
      host_start_game_label: field("Host Start Game Label", 43),
      ready_button_label: field("Ready Button Label", 44),
      not_ready_button_label: field("Not Ready Button Label", 45)
    },
    defaults: {
